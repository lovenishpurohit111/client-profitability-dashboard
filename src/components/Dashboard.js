        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-slate-500 text-xs font-mono">
              {meta?.rows} rows · {meta?.clients} clients
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="px-3 py-1.5 rounded-lg text-sm text-slate-300 focus:outline-none focus:border-emerald-500"
        ...
        <div className="space-y-6">
          ...
          <div className="glass-card animate-slide-up stagger-4">
            <div className="p-6 border-b border-slate-800">
              <ChartHeader title="Client Breakdown" subtitle="Profitability per client" icon="👥" />
            </div>
